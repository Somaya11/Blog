  ...
  return (
    <body className="aboutusBody">
      ...
      <h1 className="h2">About Us</h1>
        ...
        src="https://i.pinimg.com/originals/b6/88/45/b68845a212688ba060337267ba240746.jpg"
        alt=""
        />

        <img className="Rectangle5"
        src="https://assets.bigcartel.com/product_images/166395214/Girl_Boss.jpg?auto=format&fit=max&h=1000&w=1000"
        alt=""
        />
